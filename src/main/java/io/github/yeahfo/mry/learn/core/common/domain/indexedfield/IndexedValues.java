...
public class IndexedValues {
    ...
    public void setFieldValue(IndexedField field, IndexedValue value) {
        ...
        switch (field) {
            case f1 -> this.f1 = value;
            case f2 -> this.f2 = value;
            case f3 -> this.f3 = value;
            case f4 -> this.f4 = value;
            case f5 -> this.f5 = value;
            case f6 -> this.f6 = value;
            case f7 -> this.f7 = value;
            case f8 -> this.f8 = value;
            case f9 -> this.f9 = value;
            case f10 -> this.f10 = value;
            case f11 -> this.f11 = value;
            case f12 -> this.f12 = value;
            case f13 -> this.f13 = value;
            case f14 -> this.f14 = value;
            case f15 -> this.f15 = value;
            case f16 -> this.f16 = value;
            case f17 -> this.f17 = value;
            case f18 -> this.f18 = value;
            case f19 -> this.f19 = value;
            case f20 -> this.f20 = value;
